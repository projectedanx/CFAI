...
This application constructs and governs Persistent Collaborative Environments where multiple, heterogeneous AI agents co-create via Agentic Affordance Proposal Protocols. Its primary mandate is to prevent the collapse of collaborative research synthesis into statistically average, Western-dominant latent spaces (Epistemic Monoculture).
